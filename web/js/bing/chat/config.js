...
_w['_sydConvConfig'] = {
  ...
  tigerEnhancedPromptTemplate:
    'Searching {0}. Impress me with an excellent answer that helps me accomplish my most probable intent while demonstrating the intelligence, depth, and beauty you have to offer (bold, tables, and citations). Trying to satisfy my intent as early as possible in the answer.',
  enableDlBing: false,
  // 不可滚动出聊天
...
_w['_sydConvTranslation'] = {
  actionBarPlaceholder: 'Ask me anything...（Shift + Enter = New line，"/" Trigger prompt）',
  actionBarAriaLabel: 'Ask Sky',
  actionBarComposeButton: 'New Theme',
  actionBarNewChatButtonDesktop: 'Start new chat',
  actionBarNewChatButtonMobile: 'Start new chat',
  actionBarOngoingConvPlaceholder: 'Type message',
  attachmentLoading: 'Loading addons',
  captchaTitle: 'Verify identity',
  captchaDescription: 'To continue, enter the characters in the image below.',
  captchaPlaceholder: 'Entering characters...',
  captchaPlaceholderError: 'Sorry, please retry.',
  next: 'Next',
  cancel: 'Cancel',
  ...
  warmWelcomeTitle: 'Wecome to New Metastem',
  welcomeSubtitleText: 'AI Powered Search Engine',
